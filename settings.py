...
IPFS_ADDRESS = os.environ.get('IPFS_ADDRESS', '/dns/ipfs.infura.io/tcp/5001/https')
...
GOOGLE_CLOUD_STORAGE_UPLOAD_TIMEOUT = int(os.environ.get('GOOGLE_CLOUD_STORAGE_UPLOAD_TIMEOUT', '600'))
